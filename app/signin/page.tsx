    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="m-2 flex flex-col lg:flex-row w-full max-w-4xl bg-gray-800 rounded-lg shadow-md">
        <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-white rounded-t-lg lg:rounded-l-lg lg:rounded-tr-none">
          ...
          <h1 className="mb-2 text-4xl font-bold text-center">Welcome Page</h1>
          <p className="mb-4 text-lg text-center">Sign in to continue access</p>
          <p className="mt-auto text-sm">www.yoursite.com</p>
        </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form className="mt-8 space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-md shadow-sm hover:from-pink-500 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                >
                  Sign In
                </button>
              </div>
              <div className="flex items-center justify-center mt-6 space-x-2">
                ...
                <span className="text-sm font-medium text-gray-300">or</span>
                <span className="w-full h-px bg-gray-500"></span>
              </div>
