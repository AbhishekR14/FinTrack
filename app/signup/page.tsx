      ...
      <div className="flex items-center justify-center lg:my-[5%]">
        <div className="m-2 flex flex-col lg:flex-row w-full max-w-4xl bg-gray-800 rounded-lg shadow-md">
          <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-white rounded-t-lg lg:rounded-l-lg lg:rounded-tr-none">
            <div className="flex items-center justify-center w-16 h-16 mb-4 bg-white rounded-full cursor-pointer">
              <img
                src="/Logo.png"
                alt="FinTrack Logo"
                className="w-10 h-10"
            ...
            <div className="mb-4 text-lg text-center md:hidden">
              Track your monthly spending review your transactions by category
              and receive monthly insights.
            </div>
                ...
                <div className="rounded-md shadow-sm">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="block w-full px-3 py-2 border placeholder-gray-500 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm bg-gray-700 border-gray-600 text-white"
